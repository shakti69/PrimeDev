        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              {/* The Challenge */}
              <div className="space-y-4">
                <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-obsidian-100 flex items-center gap-2">
                  <span className="text-xs font-mono px-2 py-0.5 rounded bg-brand-500/10 text-brand-400 border border-brand-500/20">
                    01
                  </span>
                  The Engineering Challenge
                </h2>
                <div className="p-6 rounded-2xl bg-obsidian-900/50 border border-white/[0.06]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {project.keyFeatures.map((feat, idx) => (
                    ...
                    >
                      ...
                      <span className="text-xs sm:text-sm text-obsidian-200 leading-relaxed">
                        {feat}
                      </span>
                    </div>
                  ))}
                ...
                <div className="grid grid-cols-1 gap-4">
                  {project.architectureSpecs.map((spec, idx) => (
                    <Card key={idx} variant="default" className="p-5">
                      ...
                      <p className="text-xs sm:text-sm text-obsidian-300 leading-relaxed">
                        {spec.detail}
                      </p>
                    </Card>
                  ))}
            ...
            <div className="space-y-6">
              ...
              <Card variant="default" className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex justify-between py-1.5 border-b border-white/[0.05]">
                    <span className="text-obsidian-400">Category:</span>
                    <span className="text-obsidian-200 font-medium">{project.category}</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-b border-white/[0.05]">
                    <span className="text-obsidian-400">Status:</span>
                    <span className="text-obsidian-200 font-medium">{project.status}</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-b border-white/[0.05]">
                    <span className="text-obsidian-400">Release Cycle:</span>
                    <span className="text-obsidian-200 font-mono">{project.timeframe}</span>
                  </div>
                </div>
              </Card>
              ...
              <Card variant="interactive" className="p-6 space-y-4 border-brand-500/30">
                <div className="space-y-1.5">
                  ...
                  <h4 className="text-base font-bold text-white">Need a platform like this?</h4>
        ...
        <Container>
          <div className="space-y-8">
            <div className="flex items-center justify-between">
              <div>
                <span className="text-xs font-mono text-brand-400 block uppercase">Selected Work</span>
                <h3 className="text-xl font-bold text-obsidian-100">Explore Related Projects</h3>
              </div>
              <Button
                variant="outline"
                size="sm"
