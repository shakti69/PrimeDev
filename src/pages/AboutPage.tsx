          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card variant="default" className="p-6 space-y-3">
                <div className="p-2 rounded-lg bg-brand-500/10 text-brand-500 dark:text-brand-400 w-fit">
                  <Icons.Shield className="w-5 h-5" />
                </div>
                <h3 className="text-base font-bold text-[var(--text-primary)]">Security by Design</h3>
              ...
              <Card variant="default" className="p-6 space-y-3">
                ...
                <h3 className="text-base font-bold text-[var(--text-primary)]">Performance First</h3>
                <p className="text-xs text-[var(--text-muted)] leading-relaxed">
              ...
              <Card variant="default" className="p-6 space-y-3">
                <div className="p-2 rounded-lg bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 w-fit">
                  <Icons.Cpu className="w-5 h-5" />
                </div>
                <h3 className="text-base font-bold text-[var(--text-primary)]">Modular Tokens</h3>
                <p className="text-xs text-[var(--text-muted)] leading-relaxed">
              ...
              <Card variant="default" className="p-6 space-y-3">
                ...
                <h3 className="text-base font-bold text-[var(--text-primary)]">Accessibility</h3>
                <p className="text-xs text-[var(--text-muted)] leading-relaxed">
      ...
      <Section bordered withDots>
        <Container>
          <div className="max-w-4xl mx-auto space-y-10">
            ...
            <SpotlightCard className="p-8 sm:p-10 border-[var(--border-subtle)]">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                <div className="md:col-span-4 flex flex-col items-center text-center space-y-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[var(--text-primary)]">Shakti Prasad Hota</h3>
                    <p className="text-xs text-brand-500 dark:text-brand-400 font-mono">Founder & Lead Engineer</p>
                    <p className="text-[11px] text-[var(--text-muted)] mt-1">Dhenkanal, Odisha, India</p>
                  </div>
                  <div className="flex gap-2 pt-1">
                    <a
                      ...
                      className="p-2 rounded-xl bg-[var(--bg-elevated)] hover:text-brand-500 dark:hover:text-white border border-[var(--border-subtle)] transition-colors shadow-sm"
                ...
                <div className="md:col-span-8 space-y-4 text-xs sm:text-sm text-[var(--text-secondary)] leading-relaxed border-t md:border-t-0 md:border-l border-[var(--border-subtle)] pt-6 md:pt-0 md:pl-8">
                  <p>
                  ...
                  <div className="pt-2 flex flex-wrap gap-2">
                    {['Full-Stack React & Node', 'TypeScript Architecture', 'MongoDB Aggregation', 'Cybersecurity Best Practices', 'Assistive Tech'].map((skill) => (
                      <span key={skill} className="text-[10px] font-mono px-2.5 py-1 rounded-full bg-black/[0.04] dark:bg-white/[0.05] text-[var(--text-secondary)] border border-[var(--border-subtle)]">
                        {skill}
                      </span>
                    ))}
                  </div>
          ...
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-subtle)] space-y-3 shadow-sm">
                <span className="text-xs font-mono text-brand-500 dark:text-brand-400 block">STANDARD 01</span>
                <h4 className="text-base font-bold text-[var(--text-primary)]">Strict Type Safety</h4>
                <p className="text-xs text-[var(--text-muted)] leading-relaxed">
              ...
              <div className="p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-subtle)] space-y-3 shadow-sm">
                <span className="text-xs font-mono text-brand-500 dark:text-brand-400 block">STANDARD 02</span>
                <h4 className="text-base font-bold text-[var(--text-primary)]">Zero Technical Debt</h4>
                <p className="text-xs text-[var(--text-muted)] leading-relaxed">
              ...
              <div className="p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-subtle)] space-y-3 shadow-sm">
                <span className="text-xs font-mono text-brand-500 dark:text-brand-400 block">STANDARD 03</span>
                <h4 className="text-base font-bold text-[var(--text-primary)]">Reproducible Builds</h4>
                <p className="text-xs text-[var(--text-muted)] leading-relaxed">
